  ...
  return (
    <div className="flex flex-col gap-2">
      <button
        ...
        disabled={loading}
        className="inline-flex items-center justify-center gap-2.5 rounded-full border border-[#e2dfde] bg-white px-4 py-2.5 text-sm font-semibold text-[#1a1c1c] transition-colors hover:bg-[#f5f5f5] disabled:opacity-60"
      >
        {loading ? (
